...
## Overview
Analysis of customer behavior, retention, and lifetime value for an e-commerce company to improve customer retention and m maximize revenue.
...
![Cohort Analysis](/images/2_visualization.png)
...
QUERY: [3_customer_retention.sql](/Scripts/3_retention_analysis.sql)
...
- Re-engage hig-value churned customers by focusing on targeted win-back campaigns rather than broad retention efforts, as reactivating valuable users may yield higher ROI.
- Predict & preempt churn risk and use customer-specific warning indicators to proactively intervene with hat-risk users before they lapse.
...
2. **Cohort Performance Strategy**  (Customer Revenue by Cohort)
    ...
    - Apply successful strategies from high-spending 2016-2018 cohort to newer customers
